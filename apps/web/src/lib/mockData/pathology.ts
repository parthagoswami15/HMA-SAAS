...
export const mockPathologySpecimens: any[] = mockPathologyTests;
export const mockPathologyReports: any[] = mockPathologyTests;
export const mockHistologySlides: any[] = [];
export const mockCytologySlides: any[] = [];
export const mockMolecularTests: any[] = [];
export const mockPathologists: any[] = [];
