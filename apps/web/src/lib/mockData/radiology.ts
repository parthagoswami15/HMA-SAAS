...
export const mockImagingRequests = mockImagingAppointments;
export const mockImagingStudies = mockRadiologyReports;
export const mockRadiologists = [
  { id: 'u1', name: 'Dr. Radiologist A' },
  { id: 'u2', name: 'Dr. Radiologist B' }
];