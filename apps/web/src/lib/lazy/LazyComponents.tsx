...
// Patient pages
export const PatientsPage = lazyLoad(
  () => import('@/app/dashboard/patients/page')
);

export const PatientDetailsPage = lazyLoad(
  () => import('@/app/dashboard/patients/[id]/page')
);
...
// Staff pages
export const StaffPage = lazyLoad(
  () => import('@/app/dashboard/staff/page')
);

export const StaffDetailsPage = lazyLoad(
  () => import('@/app/dashboard/staff/[id]/page')
);

// Pharmacy pages
export const PharmacyPage = lazyLoad(
  () => import('@/app/dashboard/pharmacy/page')
);

// Laboratory pages
export const LaboratoryPage = lazyLoad(
  () => import('@/app/dashboard/laboratory/page')
);

// Radiology pages
export const RadiologyPage = lazyLoad(
  () => import('@/app/dashboard/radiology/page')
);
