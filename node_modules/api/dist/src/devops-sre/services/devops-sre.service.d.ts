...
export declare class DevOpsSreService {
    private prisma;
    constructor(prisma: PrismaService);
    createDeployment(createDto: CreateDeploymentDto, userId: string): Promise<any>;
    getDeployments(filterDto: DeploymentFilterDto, listDto: DeploymentListDto): Promise<any>;
    getDeployment(id: string): Promise<any>;
    rollbackDeployment(deploymentId: string, userId: string): Promise<any>;
    createIncident(createDto: CreateIncidentDto, userId: string): Promise<any>;
