...
exports.InitialIPDModule1700000000000 = void 0;
const typeorm_1 = require("typeorm");
class InitialIPDModule1700000000000 {
    async up(queryRunner) {
        ...
        await queryRunner.createForeignKey('admissions', new typeorm_1.TableForeignKey({
        ...
        await queryRunner.createForeignKey('discharges', new typeorm_1.TableForeignKey({
    ...
    async down(queryRunner) {
        ...
        if (admissionTable) {
            const patientForeignKey = admissionTable.foreignKeys.find((fk) => fk.columnNames.indexOf('patientId') !== -1);
            if (patientForeignKey) {
                await queryRunner.dropForeignKey('admissions', patientForeignKey);
            }
            const doctorForeignKey = admissionTable.foreignKeys.find((fk) => fk.columnNames.indexOf('admittingDoctorId') !== -1);
            if (doctorForeignKey) {
                await queryRunner.dropForeignKey('admissions', doctorForeignKey);
            }
            const bedForeignKey = admissionTable.foreignKeys.find((fk) => fk.columnNames.indexOf('bedId') !== -1);
            if (bedForeignKey) {
                await queryRunner.dropForeignKey('admissions', bedForeignKey);
            }
        }
        if (dischargeTable) {
            const admissionForeignKey = dischargeTable.foreignKeys.find((fk) => fk.columnNames.indexOf('admissionId') !== -1);
...
exports.InitialIPDModule1700000000000 = InitialIPDModule1700000000000;
//# sourceMappingURL=1700000000000-InitialIPDModule.js.map